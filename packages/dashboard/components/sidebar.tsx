  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-3 top-3 z-40 inline-flex h-9 w-9 items-center justify-center rounded-md border border-zinc-800 bg-zinc-900/80 text-zinc-300 backdrop-blur md:hidden"
      >
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex w-[220px] flex-col border-r border-zinc-800 bg-zinc-950/95 backdrop-blur transition-transform',
          'md:translate-x-0',
      ...
      >
        ...
        <div className="flex h-14 items-center gap-2 border-b border-zinc-800 px-4">
          ...
          <span className="font-mono text-sm font-semibold tracking-tight text-zinc-100">
            AGENT<span className="text-amber-500">·</span>WATCH
          </span>
          <button
            type="button"
            aria-label="关闭菜单"
            onClick={() => setMobileOpen(false)}
            className="ml-auto inline-flex h-7 w-7 items-center justify-center rounded text-zinc-500 hover:text-zinc-200 md:hidden"
          >
            ...
            return (
              ...
              >
                <Icon
                  width={18}
                  height={18}
                  className={cn(active ? 'text-amber-500' : 'text-zinc-500 group-hover:text-zinc-300')}
                />
